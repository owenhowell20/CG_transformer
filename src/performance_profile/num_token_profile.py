...
attention_types = ["SE3-Hyena", "Long-Conv", "FFT", "Standard"]
...
sequence_lengths_dict = {
    "Standard": token_space,
    "Long-Conv": token_space,
    "FFT": token_space,
    "SE3-Hyena": token_space,
}
...
for attn_type in attention_types:
    ...
    sequence_lengths = sequence_lengths_dict[attn_type]

    # WandB init
    wandb.init(project="SE3-Hyena", name="scaling_vs_sequence_length_" + str(attn_type))
...
wandb.init(project="SE3-Hyena", name="Scaling Plots")
...
for title, ylogs, ylabel in [
    ...
    ("Memory vs Sequence Length", memory_logs, "Peak Memory (GB)"),
]:
