...
def get_flags():
    ...
    # Model parameters
    parser.add_argument(
        "--model", type=str, default="SE3HyperHyena", help="String name of model"
    )  ### types = Standard, SE3Hyena, SE3HyperHyena

    parser.add_argument("--num_runs", type=int, default=1, help="Number of runs")
    parser.add_argument(
        "--sequence_length", type=int, default=300, help="Sequence Size"
    )
    parser.add_argument(
        "--num_sequences", type=int, default=2600, help="Number of Seqences"
    )
